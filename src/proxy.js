...
export function proxy(request) {
  ...
  const secureBetterAuthToken = request.cookies.get('__Secure-crowdfundly.session_token')?.value;
  const sessionToken = legacyToken || betterAuthToken || secureBetterAuthToken;
