      ...
      <motion.div className="p-8 max-w-7xl mx-auto w-full" variants={containerVariants} initial="hidden" animate="visible">
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[
            ...
            { label: 'Platform Credits (CR)', value: loading ? '—' : totalCredits.toLocaleString(), icon: Wallet, iconBg: 'bg-[#ffedd5]', iconColor: 'text-[#ea580c]', badge: 'Live', badgeBg: 'bg-[#fef3c7] text-[#d97706]' },
