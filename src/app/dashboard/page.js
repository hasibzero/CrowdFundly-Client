                ...
                <tbody className="divide-y divide-gray-100">
                  {myCampaigns.map((c) => (
                    <tr key={c._id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4 font-bold text-[#0f172a] text-[13px]">{(c.raised || 0).toLocaleString()} credits</td>
                      <td className="px-6 py-4 text-right text-gray-500 text-[13px]">{(c.targetAmount || 0).toLocaleString()} credits</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200/60 relative overflow-hidden group hover:shadow-md transition-shadow">
          ...
          <div className="flex items-baseline mb-3 relative z-10">
            ...
            <span className="text-lg font-bold text-gray-400 ml-2">Credits</span>
          </div>
